...
const domain = 'mini-orange\\.cn' // 更多时候是变量
const path = '/index.html?$'
const pattern = new RegExp(protocal + domain + path)
pattern.test('http://mini-orange.cn/index.html') // true
pattern.test('mini-orange.cn/index.htm') // true
```
...
```js
const pattern1 = new RegExp('mini-orange\.cn') // 结果是 /mini-orange.cn/
pattern1.test('mini-orangexcn') // true
const pattern2 = new RegExp('mini-orange\\.cn') // 结果是 /mini-orange\.cn/
pattern2.test('mini-orangexcn') // false
...
<img src="https://mini-orange.cn/assets/image/da84f66e72bdf89e7af7ce280002fc89.png" alt="" class="md-img" loading="lazy" width="796" height="270"/>

<img src="https://mini-orange.cn/assets/image/8657fed002bf746716227fc8439e4dcf.png" alt="" class="md-img" loading="lazy" width="796" height="226"/>

比较起来，还是下面的靠谱：

<img src="https://mini-orange.cn/assets/image/fd00a9e55a83ad12e7c6d2c15c0292e6.png" alt="" class="md-img" loading="lazy" width="796" height="112"/>

<img src="https://mini-orange.cn/assets/image/7a7d7d6f803dbeaa3980a746a27dc345.png" alt="" class="md-img" loading="lazy" width="796" height="169"/>
